...
class PhoneBook {
    ...
    fun addPhone(name: String, phone: String): Boolean {
        ...
        for (i in phoneBook.values) {
            if (i.contains(phone)) return false
        }
    ...
    fun removePhone(name: String, phone: String): Boolean {
        if (name !in phoneBook.keys || !phoneBook[name]!!.contains(phone)) return false
    ...
    fun phones(name: String): Set<String> {
        if (!phoneBook.keys.contains(name)) return setOf()
    ...
    override fun equals(other: Any?): Boolean {
        when {
            ...
            other !is PhoneBook -> return false
        }
        return true
    }
